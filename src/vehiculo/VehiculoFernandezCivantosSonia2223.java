 ...
 */
public class VehiculoFernandezCivantosSonia2223 {
    ...
    public VehiculoFernandezCivantosSonia2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoFernandezCivantosSonia2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
